...
CREATE TABLE IF NOT EXISTS Chat.Socialize (
    ID serial PRIMARY KEY NOT NULL,
	User_id integer NOT NULL,
	Chatroom integer NOT NULL,
    CONSTRAINT fk_User_Socialize FOREIGN KEY (User_id) REFERENCES Chat.Users(ID),
    CONSTRAINT fk_Chatroom_Socialize FOREIGN KEY (Chatroom) REFERENCES Chat.Chatroom(ID)
);